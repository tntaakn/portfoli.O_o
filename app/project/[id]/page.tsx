      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 py-24">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            {/* Category */}
            <p
              className="text-sm tracking-[0.3em] font-medium mb-3"
            ...
            {/* Title */}
            <h1
              className="text-4xl md:text-5xl lg:text-5xl font-semibold text-[#CFE7F3] leading-tight decoration-solid"
              style={{ textShadow: `0 0 60px ${project.color}30` }}
            >
              {project.title}
            </h1>
            ...
            <div className="space-y-3">
              <h2 className="text-sm tracking-[0.2em] text-[var(--forest-accent)] font-semibold">
                INTRODUCTION
              </h2>
              <p className="text-[var(--forest-light)]/80 leading-relaxed text-base font-normal">
              ...
              <ul className="space-y-4">
                {project.roleItems.map((item, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <span
                      className="w-2 h-2 rounded-full mt-2 flex-shrink-0 bg-[var(--forest-light)]/80"
                    />
                    <p className="text-[var(--forest-light)]/80 leading-relaxed text-sm md:text-base">
        ...
        {/* Additional Images Section - Vertical Stack */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <p
            className="text-[#CFE7F3] text-sm md:text-base tracking-[0.3em] uppercase mb-8 font-sans"
          >
            Thanks for watching!
          </p>
        </motion.div>
